...
app.post('/book', async (c) => {
  try {
    ...
    const { 
      hotelId, hotelName, roomType, roomQuantity, checkIn, checkOut, nights,
      guestName, guestEmail, guestPhone, guests, specialRequests, extras,
      roomTotal, extrasTotal, platformFee, total, pin 
    } = body;
    ...
    const bookingReference = 'GP-HT-' + Math.random().toString(36).substr(2, 9).toUpperCase();
