...
app.post('/book', async (c) => {
  try {
    ...
    const { 
      flightId, airline, from, to, departure, date, passengers, seats, extras,
      basePrice, seatUpgrades, extrasTotal, platformFee, total, pin 
    } = body;
    ...
    const bookingReference = 'GP-FL-' + Math.random().toString(36).substr(2, 9).toUpperCase();
